...
const Productos = [
  {
    ...
    precio: (3.7 * dollar).toFixed(2),
    stock: 0,
    descripcion:
      "Sensor optico. Resolucion 1000dpi. 3 Botones (izquierda, derecha y central c/rueda).",
  ...
  },
  {
    ...
    stock: 13,
    descripcion:
      "Este teclado Genius es el mejor complemento para hacer todo tipo de actividades. Es cómodo y práctico al momento de redactar documentos, navegar y hacer búsquedas por internet, ya sea en tu trabajo o en la comodidad del hogar.",
  ...
  },
  {
    ...
    compatibilidad:
      "Windows XP, VISTA, 7 o superior, Mac OS 10.4.6 o posterior, Linux 2.6.21 anterior",
    conexion: "Conexion USB.",
  },
  {
    id: 4,
    ...
    stock: 8,
    descripcion:
      "Fuente de alimentación ultra silenciosa, excelente refrigeración con certificado 80PLUS BRONZE",
  ...
  },
  {
    ...
    stock: 3,
    descripcion:
      "Con VERTRAG BT HOME CINEMA ™ nunca fue tan fácil disfrutar de tu música. Gracias a su conectividad Bluetooth® y óptica, este compacto sistema 2.0 permite llenar cualquier espacio con un sonido de gran pureza. Con su diseño moderno y de líneas simples, es el perfecto aliado para cualquier habitación y también para tu Smart TV.",
  ...
  },
  {
    ...
    tamano: "N/A",
    compatibilidad:
      "EPSON STYLUS T25, EPSON STYLUS TX123, EPSON STYLUS TX125, EPSON STYLUS TX133, EPSON STYLUS TX135.",
    conexion: "N/A",
  },
  {
    id: 7,
    ...
    compatibilidad:
      "Serie de impresoras HP LaserJet Pro P1100; Series de impresoras multifunción HP LaserJet Pro M1130 y M1210",
    conexion: "N/A",
  },
  {
    id: 8,
    ...
    stock: 7,
    descripcion:
      "Disco externo de muy buen funcionamiento para salvado de datos.",
  ...
  },
  {
    ...
    stock: 8,
    descripcion:
      "Con la unidad en estado sólido Gigabyte vas a incrementar la capacidad de respuesta de tu equipo. Gracias a esta tecnología podrás invertir en velocidad y eficiencia para el inicio, la carga y la transferencia de datos.",
    tamano: "Tamaño de 2.5",
  ...
  },
  {
    ...
    stock: 4,
    descripcion:
      "Placa base Intel LGA-1151 mATX con encabezado Aura Sync RGB, DDR4 2666MHz, soporte M.2, HDMI, memoria Intel Optane lista, SATA 6Gbps",
  ...
  },
  {
    ...
    stock: 10,
    descripcion:
      "Con Chromecast, vos tenes el control. Elegí entre más de 200.000 películas y programas de TV, 30 millones de canciones, además de emisoras de radio, deportes, juegos y mucho más. ¡Descubrí una amplia variedad de contenido gratuito, de suscripción o pago de miles de aplicaciones!",
  ...
  },
  {
    ...
    stock: 3,
    descripcion:
      "Intel® H410 Ultra Durable Motherboard with GIGABYTE 8118 Gaming LAN, Anti-Sulfur Resistor, Smart Fan 5",
    tamano: "N/A",
    compatibilidad: "N/A",
    conexion: "ATX",
  },
  ...
  },
  {
    ...
    stock: 10,
    descripcion:
      "MOUSE DE DIMENSIONES PEQUEÑAS CON CABLE RETRACTIL IDEAL PARA TRANSPORTAR",
  ...
  },
  {
    ...
    stock: 10,
    descripcion:
      "Salida total RMS: 1,5 watts, Potencia máxima total: 3 watts, Energía a través de puerto USB de computadora portátil o de escritorio",
    tamano: "N/A",
  ...
  },
  {
    ...
    precio: (21.3 * dollar).toFixed(2),
    stock: 1,
    descripcion: "Rendimiento aproximado: 2300 páginas al 5% de cobertura",
    // tamano: "N/A",
    compatibilidad:
      "Color LaserJet Pro M452dw/M452nw/M452dn HP Color LaserJet Pro MFP M477fnw/M477fdn/M477fdw",
    // conexion: "N/A"
  },
  {
    id: 20,
    ...
    stock: 2,
    descripcion:
      "Toner Alternativo para HP 12A. Rendimiento : 2000 Copias al 5% de cobertura de la hoja.",
    // tamano: "N/A",
    compatibilidad:
      "LaserJet 1010/1012/1015/1018/1020/1022/3015/3020/3030/3050/3052/3055 M1005/1319",
    // conexion: "N/A"
  },
  {
    id: 21,
    ...
    stock: 2,
    descripcion:
      "Toner Alternativo para HP. Rendimiento : 2000 Copias al 5% de cobertura de la hoja.",
    // tamano: "N/A",
    compatibilidad:
      "LaserJet -P1005/ P1006/ P1505/ P1505N/ M1120/ M1120N/ M1522/ M1522N/ M1522NF/ P1100/ P1102/ P1102W/ M1130/ 1210MFP / M1132MFP/ P1560/ P1566/ 1600/ 1606/ M1536DNF/ P1106",
    // conexion: "N/A"
  },
  {
    id: 22,
  ...
  },
  {
    ...
    stock: 2,
    descripcion:
      "Rendimiento : Negro 1000 copias al 5% de cobertura de la pagina",
    // tamano: "N/A",
    compatibilidad:
      "HL-1110/1110E/1110R/1112/1112E/1200 DCP-1510/1510R/1512/1512R MFC-1810/1810E/1810R/1815/dcp1617w",
    // conexion: "N/A"
  },
  {
    id: 24,
    ...
    precio: (12.6 * dollar).toFixed(2),
    stock: 2,
    descripcion:
      "RENDIMIENTO DE IMPRESION (valores aproximados): 10.000 Impresiones",
    // tamano: "N/A",
    compatibilidad:
      "Brother HL 1110, HL 1112, HL 1212W, DCP 1510, DCP 1510, DCP 1512, DCP 1518, DCP 1617NW, MFC 1810 , MFC 1811, MFC 1813, MFC 1815, MFC 1818.",
    // conexion: "N/A"
  },
  {
    id: 25,
  ...
  },
  {
    ...
    precio: (8.3 * dollar).toFixed(2),
    stock: 1,
    descripcion:
      "RENDIMIENTO DE IMPRESION (valores aproximados): 10.000 Impresiones",
    // tamano: "N/A",
    compatibilidad:
      "Laserjet Pro M102w M130fw, Laserjet Pro MFP M130fw M130nw M130fn M130a ",
    // conexion: "N/A"
  },
];
