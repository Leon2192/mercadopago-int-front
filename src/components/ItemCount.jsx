      ...
      <div className="estilosenDetalle">
        <div className="estiloenDetalle">
          <div className="botonera">
            <button className="btn btn-link" onClick={restarCantidad}>
              <img className="boton-eliminarItem" src={minus} alt="restar" />
            </button>
            <p className="conteo">{cantidad}</p>
            <button className="btn -btn-link" onClick={sumarStock}>
              <img className="boton-sumarItem" src={add} alt="sumar" />
            </button>
          </div>
